...
async def send_email(
    ...
    await aiosmtplib.send(
        message, 
        hostname=settings.mail_serverw,
...
async def send_password_reset_mail(to_email: str, username: str, token: str) -> None:
...
Best regards,
The FastAPI Tut Blog Team
"""

    await send_email(
        to_email=to_email,
        subject="Reset Your Password - Fast TUT Blog",
